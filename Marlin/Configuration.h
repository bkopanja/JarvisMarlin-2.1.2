...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  22.18,  22.18 }
    #define DEFAULT_Ki_LIST {   1.73,   1.73 }
    #define DEFAULT_Kd_LIST {  71.01,  71.01 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  40.46
  #define DEFAULT_bedKi   1.98
  #define DEFAULT_bedKd 551.95
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST // BOKI COMMENT - was enabled for BLTOUCH
